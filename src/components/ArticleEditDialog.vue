        ...
        >
          <v-row class="mt-2">
            ...
            <v-col cols="1" class="pa-1">
              <v-switch v-model="articleData.isReviewed" :disabled="!($store.state.usData.usRole == 'Admin')" :label="'Active'" dense class="ml-4"></v-switch>
            </v-col>
            <v-col cols="6" class="pa-1">
              <v-select v-model="articleData.tags" :items="items" attach chips label="Tags" dense multiple></v-select>
            </v-col>
            <v-col md="6"></v-col>
